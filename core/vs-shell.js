  ...
  async function renderScholarshipPropertiesRail(){
    ...
    const rows = results.map(function(r){
      ...
      const statusIcon = eligible === true
        ? '<svg class="ic" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1e8a5f" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="flex-shrink:0"><use href="#icon-53"/></svg>'
        : eligible === false
          ? '<svg class="ic" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#b5690a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" style="flex-shrink:0"><use href="#icon-54"/></svg>'
